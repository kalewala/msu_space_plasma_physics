...
В системе СИ величина ампера определена таким образом, что коэффициент $\mathnormal{k} = \mathnormal{c{{2}} \cdot 10^{-7}\text{Гн/м} = 8{,}9875517873681764 \cdot 10{9}\text{Н{2}м{2}/Кл{2}}}$ (или $\text{Ф}^{-1} \cdot м$).
